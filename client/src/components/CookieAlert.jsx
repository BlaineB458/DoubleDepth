...
const CookieAlert = () => {
    ...
    return (
      <div>
          ...
          <div className={`fixed z-[999px] left-5 w-[90vw] md:left-[25vw] md:w-[50vw] border-[0.5px] border-zinc-300/20 rounded-xl bottom-5 shadow-md bg-zinc-900/50 text-zinc-50 p-4 text-center backdrop-blur-sm transition-all ease-in-out duration-500 ${showAlert ? 'bottom-5' : '-bottom-[40vh] pointer-events-none'}`}>
            <p>
